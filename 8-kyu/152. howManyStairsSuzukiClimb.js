...
//   let sundaySum = s[0].reduce((a, v) => a + v, 0);
//   let mondaySum = s[1].reduce((a, v) => a + v, 0);
//   let tuesdaySum = s[2].reduce((a, v) => a + v, 0);
//   let wednesdaySum = s[3].reduce((a, v) => a + v, 0);
//   let thursdaySum = s[4].reduce((a, v) => a + v, 0);
//   let fridaySum = s[5].reduce((a, v) => a + v, 0);
//   let saturdaySum = s[6].reduce((a, v) => a + v, 0);
//   let sumEstimate =
//     (sundaySum +
//       mondaySum +
//       tuesdaySum +
